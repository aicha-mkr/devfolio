      ...
      <div className="section-container py-16 flex flex-col justify-center">
        ...
        <div className="flex flex-col skills-wrapper">
          <div className="flex flex-col">
            ...
            <h2 className="text-[1.6rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
                 Here are the languages and technologies I use to build robust applications.{" "}
            </h2>   
          </div>
          <div className="mt-10">
